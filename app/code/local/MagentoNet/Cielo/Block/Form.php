...
class MagentoNet_Cielo_Block_Form extends Mage_Payment_Block_Form
{
    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('MagentoNet_Cielo2/form.phtml');
    }
    ...
    public function getParcelas(){
        ...
        $max_parcelas = Mage::getStoreConfig('payment/MagentoNet_Cielo/num_max_parc');
        $valor_minimo = Mage::getStoreConfig('payment/MagentoNet_Cielo/valor_minimo');
        $parcelas_sem_juros = Mage::getStoreConfig('payment/MagentoNet_Cielo/parcelamento_semjuros');
        $taxa_juros = Mage::getStoreConfig('payment/MagentoNet_Cielo/parcelamento_juros');

        $descontoavista = Mage::getStoreConfig('payment/MagentoNet_Cielo/desconto_avista');
        $descontoavista_valor = Mage::getStoreConfig('payment/MagentoNet_Cielo/valor_desconto_avista');
